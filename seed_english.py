...
ACTIVITIES = {
    1: [  # Bienvenida e introducción
        {'tipo': 'multiple', 'titulo': 'Greetings Vocabulary', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Hello" mean?', 'opciones': ['Hola', 'Adiós', 'Gracias', 'Por favor'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'More Greetings', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Good morning" mean?', 'opciones': ['Buenos días', 'Buenas noches', 'Buenas tardes', 'Hola'], 'respuesta': '0'}},
    ...
    2: [  # Información personal
        {'tipo': 'multiple', 'titulo': 'Countries Vocabulary', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Mexico" mean in Spanish?', 'opciones': ['México', 'España', 'Colombia', 'Argentina'], 'respuesta': '0'}},
    ...
    4: [  # Verbo To Be
        ...
        {'tipo': 'multiple', 'titulo': 'Pronouns', 'instrucciones': 'Select the correct pronoun.',
         'config': {'pregunta': 'What does "I" mean?', 'opciones': ['Yo', 'Tú', 'Él', 'Ella'], 'respuesta': '0'}},
    ],
    5: [  # Descripciones
        {'tipo': 'multiple', 'titulo': 'Adjectives', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Tall" mean?', 'opciones': ['Alto/a', 'Bajo/a', 'Gordo/a', 'Delgado/a'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'Colors', 'instrucciones': 'Choose the correct color.',
         'config': {'pregunta': 'What does "Blue" mean?', 'opciones': ['Azul', 'Rojo', 'Verde', 'Amarillo'], 'respuesta': '0'}},
    ...
    7: [  # Familia
        {'tipo': 'multiple', 'titulo': 'Family Members', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Mother" mean?', 'opciones': ['Madre', 'Padre', 'Hermano', 'Hermana'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'More Family', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Brother" mean?', 'opciones': ['Hermano', 'Hermana', 'Primo', 'Tío'], 'respuesta': '0'}},
    ...
    10: [  # Simple Present
        ...
        {'tipo': 'multiple', 'titulo': 'Daily Actions', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Wake up" mean?', 'opciones': ['Despertarse', 'Dormirse', 'Comer', 'Trabajar'], 'respuesta': '0'}},
    ],
    11: [  # Tiempo
        ...
        {'tipo': 'multiple', 'titulo': 'Months', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "January" mean?', 'opciones': ['Enero', 'Febrero', 'Marzo', 'Abril'], 'respuesta': '0'}},
    ...
    14: [  # Hobbies
        {'tipo': 'multiple', 'titulo': 'Hobbies', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Swimming" mean?', 'opciones': ['Natación', 'Correr', 'Leer', 'Cocinar'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'Sports', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Soccer" mean?', 'opciones': ['Fútbol', 'Baloncesto', 'Béisbol', 'Tenis'], 'respuesta': '0'}},
    ...
    16: [  # Places
        {'tipo': 'multiple', 'titulo': 'City Places', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Hospital" mean in Spanish?', 'opciones': ['Hospital', 'Escuela', 'Parque', 'Banco'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'More Places', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Supermarket" mean?', 'opciones': ['Supermercado', 'Farmacia', 'Restaurante', 'Biblioteca'], 'respuesta': '0'}},
    ...
    18: [  # Directions
        {'tipo': 'multiple', 'titulo': 'Directions', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Turn left" mean?', 'opciones': ['Gira a la izquierda', 'Gira a la derecha', 'Sigue derecho', 'Detente'], 'respuesta': '0'}},
    ...
    19: [  # Food
        {'tipo': 'multiple', 'titulo': 'Food Vocabulary', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Rice" mean?', 'opciones': ['Arroz', 'Pan', 'Carne', 'Pescado'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'Fruits', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Apple" mean?', 'opciones': ['Manzana', 'Naranja', 'Plátano', 'Uva'], 'respuesta': '0'}},
    ...
    23: [  # Actividades
        {'tipo': 'multiple', 'titulo': 'Action Verbs', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Working" mean?', 'opciones': ['Trabajando', 'Jugando', 'Comiendo', 'Durmiendo'], 'respuesta': '0'}},
    ...
    25: [  # Simple Past
        ...
        {'tipo': 'multiple', 'titulo': 'Irregular Verbs', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Go - Went" mean?', 'opciones': ['Ir - Fui', 'Venir - Vine', 'Hacer - Hice', 'Decir - Dije'], 'respuesta': '0'}},
    ...
    29: [  # Vocabulario futuro
        {'tipo': 'multiple', 'titulo': 'Future Time Words', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Tomorrow" mean?', 'opciones': ['Mañana', 'Ayer', 'Hoy', 'Anoche'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'Next...', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Next year" mean?', 'opciones': ['El próximo año', 'El año pasado', 'Este año', 'Cada año'], 'respuesta': '0'}},
    ...
    31: [  # Oficina
        {'tipo': 'multiple', 'titulo': 'Office Vocabulary', 'instrucciones': 'Select the correct translation.',
         'config': {'pregunta': 'What does "Computer" mean?', 'opciones': ['Computadora', 'Teléfono', 'Escritorio', 'Impresora'], 'respuesta': '0'}},
        {'tipo': 'multiple', 'titulo': 'More Office', 'instrucciones': 'Choose the correct translation.',
         'config': {'pregunta': 'What does "Meeting" mean?', 'opciones': ['Reunión', 'Oficina', 'Trabajo', 'Horario'], 'respuesta': '0'}},
    ...
    34: [  # Repaso
        ...
        {'tipo': 'multiple', 'titulo': 'Key Vocabulary Review', 'instrucciones': 'Final vocabulary check.',
         'config': {'pregunta': 'You have completed the vocabulary review! Ready to continue?',
                    'opciones': ['Yes, I am ready!', 'No', 'Maybe', 'Later'], 'respuesta': '0'}},
    ],
    35: [  # Proyecto final
